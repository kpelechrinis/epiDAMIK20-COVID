...
```{r loadData}
home_pcg <- read.csv("http://www.pitt.edu/~kpele/epiDAMIK_home_pcg_us.csv")
demo_data <- read.csv("http://www.pitt.edu/~kpele/demo_data.csv")
demo_data_race <- read.csv("http://www.pitt.edu/~kpele/demo_datarace.csv")
